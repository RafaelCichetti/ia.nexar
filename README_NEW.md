...
```bash
# PowerShell
Invoke-RestMethod -Uri "http://localhost:3000/webhook/test" -Method POST -Headers @{"Content-Type"="application/json"} -Body '{"client_id": "pizzaria_bella_vista", "message": "Olá!"}'
```
